...
const experimentGraph3 = new Chart(ctx3, {
    ...
    options: {
        ...
        scales: {
            ...
            y: {
                title: { display: true, text: 'Angle (°)/ seconds (s)' },
                ticks: {
                    beginAtZero: false, // Let it adapt but with a limit
                },
                afterDataLimits: (scale) => {
...
const experimentGraph5 = new Chart(ctx5, {
    ...
    options: {
        ...
        scales: {
            ...
            y: {
                title: { display: true, text: 'Angle (°) / second (s)' },
                ticks: {
                    beginAtZero: false
                },
                afterDataLimits: (scale) => {
...
function resetStateGraph2() {
    if (experimentGraph3) {
        ...
        if (experimentGraph3.data.datasets.length > 1) {
            const dataset2 = experimentGraph3.data.datasets[1];
            dataset2.borderColor = 'red';
            dataset2.borderWidth = 2;
            dataset2.borderDash = [10, 5];
            dataset2.pointRadius = 0;
...
// ****************PERIODICAL CALLS**********************
    ...
    setInterval(() => { generateStateLegend(); generateStateLegend2(); generateActionLegend(); }, 2000);
