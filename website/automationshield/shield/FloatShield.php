...
include 'FloatShield_session.php'; // Include the session management file
?>
...
<head>
    ...
    <title>AutomationShield: FloatShied</title>
    ...
    <script src="FloatShield.js"></script> <!-- Page-Specific Script -->
...
<div class="automation-shield-workbench">
  ...
  <div class="automation-shield-workbench-side-panel">
    <!-- SIDE PANEL HEADER -->
    <div class="side-panel-header"> FloatShield </div>
    <!-- SIDE PANEL DIVIDER -->
    ...
    <!-- ************************************SIDE PANEL FORM PID********************************-->
      ...
      <form id="PID-experiment-form" class="side-panel-form">
        ...
        <div class="side-panel-form-line-wrapper">
           ...
           <input id="Kp" name="Kp" type="number" step=".01" value="0.25" class="side-panel-form-line-input" required>
        </div>
        ...
        <div class="side-panel-form-line-wrapper">
          ...
          <input id="Ti" name="Ti" type="number" step=".01" value="5" class="side-panel-form-line-input" required>
        </div>
        ...
        <div class="side-panel-form-line-wrapper">
          ...
          <input id="Td" name="Td" type="number" step=".01" value="0.01" class="side-panel-form-line-input" required>
        </div>
        ...
        <div class="side-panel-form-img-wrapper">
          <a href="https://github.com/gergelytakacs/AutomationShield/wiki/FloatShield" target="_blank" class="side-panel-form-img-href">
            <img class="side-panel-form-img" alt="automationshield" src="https://mrsolutions.sk/automationshield/img/FloatShieldGithub.png">
          </a>
        </div>
          ...
          <div class="side-panel-form-info-line">
            <div class="side-panel-form-info-var lq tooltip">
              ...
              <div class="side-panel-form-info-data">
                (0.45815, 0.1997, 0.63981, -0.00252)
              </div>
            </div>
        </div> 
