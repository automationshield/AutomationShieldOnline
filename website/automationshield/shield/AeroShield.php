...
include 'AeroShield_session.php'; // Include the session management file
?>
...
<head>
    ...
    <title>AutomationShield: AeroShield</title>
    ...
    <script src="AeroShield.js"></script> <!-- Page-Specific Script -->
...
<div class="automation-shield-workbench">
  ...
  <div class="automation-shield-workbench-side-panel">
    <!-- SIDE PANEL HEADER -->
    <div class="side-panel-header"> AeroShield </div>
    <!-- SIDE PANEL DIVIDER -->
    ...
    <div class="side-panel-select">
      <select>
        ...
        <option value="OpenLoop" data-txt="txtOpenLoop"></option>
      </select>
    ...
    <!-- ************************************SIDE PANEL FORM PID********************************-->
      ...
      <form id="PID-experiment-form" class="side-panel-form">
        ...
        <div class="side-panel-form-line-wrapper">
           ...
           <input id="Kp" name="Kp" type="number" step=".01" value="1.55" class="side-panel-form-line-input" required>
        </div>
        ...
        <div class="side-panel-form-line-wrapper">
          ...
          <input id="Ti" name="Ti" type="number" step=".01" value="0.55" class="side-panel-form-line-input" required>
        </div>
        ...
        <div class="side-panel-form-line-wrapper">
          ...
          <input id="Td" name="Td" type="number" step=".01" value="0.25" class="side-panel-form-line-input" required>
        </div>
        ...
        <div class="side-panel-form-img-wrapper">
          <a href="https://github.com/gergelytakacs/AutomationShield/wiki/AeroShield" target="_blank" class="side-panel-form-img-href">
            <img class="side-panel-form-img" alt="automationshield" src="https://mrsolutions.sk/automationshield/img/aeroshield.png">
          </a>
        </div>
      ...
      <input type="hidden" id="experiment" name="experiment" value="identification">
        ...
        <div class="side-panel-form-line-wrapper-column">
          <div class="side-panel-form-line-input-text-column tooltip">
            <span data-txt="txtMotorPower">&nbsp;</span> 
            <span class="tooltiptext2" data-txt="txttooltipMotorPower">&nbsp;</span>
          </div>
      ...
      <input type="hidden" id="experiment" name="experiment" value="LQIman">
        ...
        <div class="side-panel-form-manual-tip-header tooltip"">
          ...
          <div class="side-panel-form-manual-tip">
            <div class="side-panel-form-manual-tip-txt" data-txt="txtOpenLoopTip">&nbsp;</div>
      ...
      <!-- **********************************************************************************-->
      <!-- *********************************SIDE PANEL FORM Open Loop************************-->
      
      <form id="OPENLOOP-experiment-form" class="side-panel-form">
      <input type="hidden" id="experiment" name="experiment" value="openloop">
