...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($experiment === 'LQI') {
        ...
        $Ksu = isset($_POST['Ksu']) ? $_POST['Ksu'] : null;
        $Kq = isset($_POST['Kq']) ? $_POST['Kq'] : null;
        $Kdq = isset($_POST['Kdq']) ? $_POST['Kdq'] : null;
        ...
        if ($id && $timer > 0) {
            ...
            $sql = "UPDATE FurutaShield SET Experiment = ?, START = ?, TIMER = ?, r1 = ?, r2 = ?, r3 = ?, r4 = ?, r5 = ?, r6 = ?, Ksu = ?, Kq = ?, Kdq = ?, Ke = ?  WHERE arduino_online_id = ?";
            $stmt = $db->prepare($sql);

            if ($stmt) {
                logDebug("Prepared update query for FurutaShield");
                $stmt->bind_param(
                    'ssdddddddddddi',
        ...
        $timer = isset($_POST['timer2']) ? $_POST['timer2'] : null;
        $status = 'START';
        $reference = isset($_POST['Reference']) ? $_POST['Reference'] : null;
        $Ksu = isset($_POST['Ksu']) ? $_POST['Ksu'] : null;
        $Kq = isset($_POST['Kq']) ? $_POST['Kq'] : null;
